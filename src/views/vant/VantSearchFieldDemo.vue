...
<template>
  <div class="sel-demo">
    <van-nav-bar title="VantSearchField 示例" left-text="返回" left-arrow @click-left="$router.back()" />
    ...
    <div class="card">
      <p class="hint">· 组件渲染为 <code>van-field</code>，可直接放入 <code>van-cell-group</code> / <code>van-form</code>。</p>
      <p class="hint">· <code>fetch</code> 远程联想：输入停顿 <code>debounce</code>(默认 300ms) 后才请求，并带竞态保护。</p>
      <p class="hint">· <code>options</code> 本地过滤：无 fetch 时按关键词过滤静态数组；支持字符串 / 对象自定义字段。</p>
