    ...
    <div class="container">
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值：<code>{{ region || '（空）' }}</code></p>
      </div>
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值：<code>{{ org || '（空）' }}</code></p>
      </div>
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值：<code>{{ clearableVal || '（空）' }}</code></p>
      </div>
      ...
      <div class="card">
        ...
        <VantTreeSelect
          ...
          readonly
        />
        <p class="hint">禁用值：<code>{{ disabledVal }}</code> ｜ 只读值：<code>{{ readonlyVal }}</code></p>
      </div>
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值：<code>{{ requiredVal || '（空）' }}</code></p>
      </div>

      <div class="section-title">⑥ change 事件回显（值 + 完整路径）</div>
      <div class="card">
        <p class="hint">选中值：<code>{{ lastValue || '（未选择）' }}</code></p>
        <p class="hint">完整路径：<code>{{ lastPath || '（未选择）' }}</code></p>
      </div>
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值（以「 > 」分隔回显）：<code>{{ sepVal || '（空）' }}</code></p>
      </div>
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值：<code>{{ maxDepthVal || '（空）' }}</code>（市及以下的子级已被裁为可选叶子）</p>
      </div>
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值：<code>{{ unevenVal || '（空）' }}</code>（点「北京市」一级即完成；「上海市」到二级即完成）</p>
      </div>
      ...
      <div class="card">
        <VantTreeSelect
          ...
          @change="onChange"
        />
        <p class="hint">当前值：<code>{{ parentVal || '（空）' }}</code>（进入「省」列后，点末尾「选择「浙江省」」即直接选中省级，无需下钻到区）</p>
      </div>
    </div>
  </div>
</template>
